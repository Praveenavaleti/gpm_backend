...
import com.taskmanagement.dao.ProjectStatusDao;
...
import com.taskmanagement.dto.ProjectStatusAddRequest;
import com.taskmanagement.dto.ProjectStatusResponse;
...
public class ProjectController {
	...
	public ResponseEntity<CommonApiResponse> addProjectStatus(@RequestBody ProjectStatusAddRequest request) {
		...
		com.taskmanagement.entity.ProjectStatus status = new com.taskmanagement.entity.ProjectStatus();
		...
		com.taskmanagement.entity.ProjectStatus addedStatus = projectStatusDao.save(status);
	...
	public ResponseEntity<ProjectStatusResponse> fetchAllProjectStatusByEmployee(@RequestParam("projectId") Integer projectId) {
		...
		List<com.taskmanagement.entity.ProjectStatus> statuses = projectStatusDao.findByProjectOrderByIdDesc(project);
